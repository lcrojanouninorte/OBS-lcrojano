class EmpatiaChartController{
    constructor(VisDataSet){
        'ngInject';
...
export const EmpatiaChartComponent = {
    templateUrl: './views/app/components/empatia-chart/empatia-chart.component.html',
    controller: EmpatiaChartController,
    controllerAs: 'vm',
    bindings: {}
}
